...
Native web components (Lit, light DOM) for michi-vz charts.
...
| **[@michi-vz/wc](https://www.npmjs.com/package/@michi-vz/wc)** (this package) | Native web components (Lit, light DOM) |
