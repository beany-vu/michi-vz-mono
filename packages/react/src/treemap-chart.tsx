// Per-chart subpath: `import { ... } from "@michi-vz/react/treemap-chart"`.
...
import { evaluateDataState, mountTreemapChart } from "@michi-vz/core";
import type {
  TreemapChartProps,
  ChartInstance,
  ChartContext,
...
export type TreemapChartReactProps = TreemapChartProps & {
