...
function mount(extra: Partial<PieChartProps> = {}, ticker?: ManualTicker) {
  const host = document.createElement("div");
  document.body.appendChild(host);
  const chart = mountPieChart(
    host,
...
describe("pie chart timeline (off by default)", () => {
...
describe("pie chart timeline (enabled)", () => {
...
describe("pie chart timeline control UI", () => {
