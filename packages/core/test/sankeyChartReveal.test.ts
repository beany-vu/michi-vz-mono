...
describe("SankeyChart progressiveDraw off by default", () => {
  it("renders no clipPath and full links/nodes when the prop is unset", () => {
...
describe("SankeyChart progressiveDraw canvas mode", () => {
