---
title: Charts
description: "Danh mục biểu đồ michi-vz: 17 loại biểu đồ cho xu hướng, cấu thành, so sánh, tương quan và luồng, mỗi loại đều có bản demo trực tiếp trong React, Vue, Svelte, Angular và web components."
---
# Danh mục biểu đồ

Mười bảy biểu đồ độc lập với framework. Mỗi trang có một ví dụ, cách sử dụng trên mọi framework, và một bảng ngữ cảnh LLM.
