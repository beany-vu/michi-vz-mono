...
Gắn `date` cho từng dòng rồi bật `timeline`: biểu đồ tornado thành câu chuyện theo từng năm với nút play và thanh tua riêng, mỗi lần hiển thị cán cân trái/phải của một giai đoạn. Mặc định tắt - không bật thì biểu đồ giữ nguyên.

<TimelinePlayDemo chart="dual-horizontal-bar-chart" hint="Bấm nút play dưới biểu đồ: dữ liệu chạy qua từng năm, mỗi lần một snapshot. Kéo thanh tua để nhảy đến năm bất kỳ." />
