...
export const ui: Record<LocaleKey, UiStrings> = {
  ...
  fr: {
    ...
    footerStarAsk:
      "Si cela vous a fait sourire, une étoile sur GitHub nourrit le chat. Les pull requests sont les bienvenues aussi ; le chat relit chacune en personne.",
    ...
    michiNoteText:
      "Il y a bel et bien un chat à Genève qui s'appelle Michi. Chaque projet de cet atelier porte ce nom, et voici la contribution de Michi : dormir pendant la revue de code, puis s'en attribuer le mérite.",
  ...
  nl: {
    ...
    footerStarAsk:
      "Als dit u een glimlach gaf, houdt een ster op GitHub de kat gevoed. Pull requests zijn ook welkom; de kat beoordeelt elke persoonlijk.",
    ...
    michiNoteText:
      "Er is echt een kat in Genève die Michi heet. Elk project in deze werkplaats is naar Michi vernoemd, en dit is de bijdrage van Michi: door de code review heen slapen en daarna de eer opstrijken.",
  ...
  vi: {
    ...
    footerStarAsk:
      "Nếu bạn thấy vui, một ngôi sao trên GitHub sẽ giúp nuôi mèo. Cũng rất hoan nghênh pull request; mèo sẽ đích thân xem xét từng cái.",
    ...
    michiNoteText:
      "Ở Geneva thật sự có một chú mèo tên Michi. Mọi dự án trong xưởng này đều mang tên Michi, và đây là đóng góp của Michi: ngủ suốt buổi review code, rồi nhận hết công lao.",
...
export const chartNames: Record<LocaleKey, Record<string, string>> = {
  root: {
    ...
    "comparable-vertical-bar": "Comparable Vertical Bar",
  ...
  fr: {
    ...
    "comparable-vertical-bar": "Barres comparables verticales",
  ...
  nl: {
    ...
    "comparable-vertical-bar": "Vergelijkbare verticale staven",
