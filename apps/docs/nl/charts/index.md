---
title: Grafieken
description: "De grafiekcatalogus van michi-vz: 17 grafiektypen voor trends, samenstelling, vergelijking, correlatie en stroom, elk met live demo's in React, Vue, Svelte, Angular en web components."
---
# Grafiekcatalogus

Zeventien framework-onafhankelijke grafieken. Elke pagina bevat een voorbeeld, het gebruik in elk framework en een LLM-contextpaneel.
